...
def test_system_prompt_mentions_pattern_notes() -> None:
    ...
    assert "Output word_base and all non-Russian fields in English." in prompt
...
def test_system_prompt_mentions_spanish_source_language() -> None:
    ...
    assert "Output word_base and all non-Russian fields in the source language." in prompt
